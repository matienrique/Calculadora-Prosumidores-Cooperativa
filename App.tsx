          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="font-black text-white uppercase text-xs tracking-[0.2em] mb-2 italic">Secretaría de Energía</p>
                  <p className="text-sm leading-relaxed text-white/90">San Lorenzo 1949. Piso 2. Oficina 228.</p>
                  <p className="text-sm leading-relaxed text-white/90">Ciudad de Rosario</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 md:text-right">
              ...
              <div className="flex items-center md:justify-end space-x-3">
                <span className="text-sm font-medium text-white/90">Cel: (0342) 6400825</span>
                <div className="bg-white/20 p-2 rounded-lg backdrop-blur-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
              ...
              <div className="flex items-center md:justify-end space-x-3">
                <span className="text-sm font-medium text-white/90">secretariaenergia@santafe.gov.ar</span>
                <div className="bg-white/20 p-2 rounded-lg backdrop-blur-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
