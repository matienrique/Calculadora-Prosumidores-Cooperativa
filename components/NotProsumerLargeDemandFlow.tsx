  ...
  if (showResults) {
    ...
    return (
      <div id="results-content" className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
        ...
        <div className="mt-12">
          <FeedbackForm userType="No Prosumidor Gran Demanda" />
        </div>
    ...
    <div className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
      ...
      <div className={sectionClass}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div><label className={labelClass}>Importe horario pico</label><input type="number" className={inputClass} value={formData.tarifaPico} onChange={(e) => handleInputChange('tarifaPico', e.target.value)} /></div>
          <div><label className={labelClass}>Importe horario resto</label><input type="number" className={inputClass} value={formData.tarifaRestoSin} onChange={(e) => handleInputChange('tarifaRestoSin', e.target.value)} /></div>
          <div><label className={labelClass}>Precio unitario/Tarifa resto ($/kWh)</label><input type="number" step="any" className={inputClass} value={formData.precioUnitarioResto} onChange={(e) => handleInputChange('precioUnitarioResto', e.target.value)} /></div>
          <div><label className={labelClass}>Importe horario valle</label><input type="number" className={inputClass} value={formData.tarifaValle} onChange={(e) => handleInputChange('tarifaValle', e.target.value)} /></div>
          <div>
