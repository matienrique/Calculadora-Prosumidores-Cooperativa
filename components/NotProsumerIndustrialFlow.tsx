      ...
      <div id="results-content" className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-gradient-to-r from-[#FF5F6D] to-[#B83AF3] p-6 rounded-3xl shadow-xl text-center text-white">
            <p className="text-orange-100 text-[10px] font-black uppercase mb-1 tracking-widest">Factura estimada (Prosumidor)</p>
        ...
        <div className="text-center bg-orange-50 p-4 rounded-2xl border border-orange-100 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-gradient-to-r from-[#FF5F6D] to-[#B83AF3] p-6 rounded-3xl shadow-xl text-center text-white flex flex-col justify-center">
            <p className="text-orange-100 text-xs font-black uppercase mb-2 tracking-widest">Período de recuperación</p>
        ...
        <div className="mt-12">
          <FeedbackForm userType="No Prosumidor Industrial" />
        </div>
