  ...
  return (
    <div className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-black text-slate-800 tracking-tighter uppercase">Simulador Comercial</h2>
      ...
      {programVersion && (
        ...
        <div className="pt-6 border-t grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2"><label className={`${labelClass} text-emerald-600`}>TOTAL A PAGAR ($) *</label><input type="number" step="any" className={`${inputClass} border-emerald-600 bg-emerald-50 font-black text-xl shadow-inner`} value={formData.totalToPay} onChange={(e) => handleInputChange('totalToPay', e.target.value)} /></div>
        </div>
      </div>
