...
const NotProsumerAssociationsFlow: React.FC<Props> = ({ onBack }) => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      pdf.save('resultados-asociaciones.pdf');
    } catch (error) {
  ...
  if (showResults) {
    ...
    return (
      <div id="results-content" className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
        ...
        <div className="mt-12">
          <FeedbackForm userType="No prosumidor. Asociaciones" />
        </div>
    ...
    <div className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
      ...
      <div className="bg-gradient-to-r from-[#FF5F6D] to-[#B83AF3] p-6 rounded-3xl text-white flex items-center justify-between shadow-xl">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-xs font-black uppercase tracking-widest italic">Simulación Asociaciones</span>
        </div>
...
export default NotProsumerAssociationsFlow;
