  ...
  if (showResults) {
    ...
    return (
      <div id="results-content" className="space-y-8 animate-fadeIn max-w-4xl mx-auto">
        ...
        <div className="mt-12">
          <FeedbackForm userType="Prosumidor Industrial" />
        </div>
    ...
    <div className="space-y-8 animate-fadeIn max-w-4xl mx-auto pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <button 
          ...
          className={`p-6 rounded-2xl border-2 transition-all text-center ${programVersion === '4.0' ? 'border-orange-600 bg-orange-50 shadow-md' : 'border-slate-200 bg-white hover:border-orange-300 shadow-sm'}`}
        >
          <span className="text-lg font-black text-orange-600 uppercase">Soy Prosumidor 4.0</span>
        </button>
        <button 
          onClick={() => setProgramVersion('legacy')}
          className={`p-6 rounded-2xl border-2 transition-all text-center ${programVersion === 'legacy' ? 'border-orange-600 bg-orange-50 shadow-md' : 'border-slate-200 bg-white hover:border-orange-300 shadow-sm'}`}
        >
          <span className="text-lg font-black text-orange-600 uppercase block">Pertenezco a un programa anterior</span>
